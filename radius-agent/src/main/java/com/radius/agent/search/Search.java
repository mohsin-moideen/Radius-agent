...
public class Search {
	...
	public Map<Property, Integer> getMatchingProperties (SearchParams params) {
		...
		for (Property property : searchResults) {
			if (!isFilteredByDistance(searchResults, property, propertyMatch, params)) {
				...
				filterByBedrooms(property, propertyMatch, params);
				filterByBathrooms(property, propertyMatch, params);
			}
		}
	 ...
	 * @param params
	 */
	private void filterByBedrooms(Property property, Map<Property, Integer> propertyMatch, SearchParams params) {
		int score = 0;
	 ...
	 * @param params
	 */
	private void filterByBathrooms(Property property, Map<Property, Integer> propertyMatch, SearchParams params) {
		int score = 0;
